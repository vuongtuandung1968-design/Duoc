...
-- Thông báo chào mừng
Notification.new("<Color=Blue>Chúc Mừng 2026 Và tạm Biệt 2025<Color=/>"):Display()
task.wait(3)
Notification.new("<Color=Blue>Chúc Mọi Người Tết Vui Vẻ<Color=/>"):Display()
task.wait(3)
Notification.new("<Color=Blue>Bác Hồ Chí Minh Muôn Năm<Color=/>"):Display()
task.wait(3)
Notification.new("<Color=Blue>Bác Hồ Vĩ Đại Muôn Năm<Color=/>"):Display()
task.wait(3)
Notification.new("<Color=Blue>Năm Mới Chúc Nước Việt Nam Vui Vẻ<Color=/>"):Display()
task.wait(3)
Notification.new("<Color=Blue>Cali con cặc tuổi lồn<Color=/>"):Display()
task.wait(3)
Notification.new("<Color=Blue>Thằng Diệm Liệt Não ăn cứt<Color=/>"):Display()
task.wait(3)
Notification.new("<Color=Blue>Tiro Hub yêu Bác Hồ<Color=/>"):Display()
task.wait(3)
